...
import com.yibingo.race.core.service.ImgTravelCardExtendsService;
 ...
 */
@Api(
        value = "imgtravelcard_extends",
        tags = "行程卡照片扩展管理"
)
@RestController
@RequestMapping("core/imgtravelcard/extends")
public class ImgTravelCardExtendsController {
    ...
    public Result getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            ImgTravelCardFilterMapper mapper = new ImgTravelCardFilterMapper();
        ...
        return Result.success(imgTravelCardExtendsService.getListByFilter(mapper));
    }

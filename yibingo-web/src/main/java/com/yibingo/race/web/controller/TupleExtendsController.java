...
import com.yibingo.race.core.service.TupleExtendsService;
...
@RestController
@RequestMapping("core/tuple/extends")
public class TupleExtendsController {
    ...
    public Result getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            TupleFilterMapper mapper = new TupleFilterMapper();
        ...
        return Result.success(tupleExtendsService.getListByFilter(mapper));
    }

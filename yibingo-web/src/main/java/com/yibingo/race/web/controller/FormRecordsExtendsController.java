...
import com.yibingo.race.core.service.FormRecordsExtendsService;
 ...
 */
@Api(
        value = "formrecords_extends",
        tags = "表单记录扩展管理"
)
@RestController
@RequestMapping("core/formrecords/extends")
public class FormRecordsExtendsController {
    ...
    public Result getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            FormRecordsFilterMapper mapper = new FormRecordsFilterMapper();
        ...
        return Result.success(formRecordsExtendsService.getListByFilter(mapper));
    }

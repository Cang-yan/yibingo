...
import com.yibingo.race.core.service.FormImgExtendsService;
 ...
 */
@Api(
        value = "formimg_extends",
        tags = "表单图片选择扩展管理"
)
@RestController
@RequestMapping("core/formimg/extends")
public class FormImgExtendsController {

    @Autowired
    private  FormImgExtendsService formImgExtendsService;
    ...
    public Result getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            FormImgFilterMapper mapper = new FormImgFilterMapper();
        ...
        return Result.success(formImgExtendsService.getListByFilter(mapper));
    }

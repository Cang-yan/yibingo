...
import com.yibingo.race.core.service.FormLabelExtendsService;
 ...
 */
@Api(
        value = "formlabel_extends",
        tags = "表单标签扩展管理"
)
@RestController
@RequestMapping("core/formlabel/extends")
public class FormLabelExtendsController {

    @Autowired
    private  FormLabelExtendsService formLabelExtendsService;
    ...
    public Result getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            FormLabelFilterMapper mapper = new FormLabelFilterMapper();
        ...
        return Result.success(formLabelExtendsService.getListByFilter(mapper));
    }

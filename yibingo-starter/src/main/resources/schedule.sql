/*
 ...
 Source Schema         : ql-admin

 Target Server Type    : MySQL
 Target Server Version : 80018
 File Encoding         : 65001

 Date: 23/11/2021 12:13:55
*/
...
CREATE TABLE `schedule_group`  (
  `group_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '注释',
...
CREATE TABLE `schedule_job`  (
  `id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '任务id',
...
CREATE TABLE `schedule_log`  (
  `id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '任务日志id',

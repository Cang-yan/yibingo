 ...
 */
@Service
public class FormCountExtendsService {

    @Autowired
    FormCountService formCountService;

    public List<FormCount> getListByFilter(FormCountFilterMapper filterMapper) {

        QueryWrapper<FormCount> wrapper = new QueryWrapper<>();
        ...
        Page<FormCount> markPage = new Page<>(page, row);

        Page<FormCount> resultList = formCountService.page(markPage, wrapper);

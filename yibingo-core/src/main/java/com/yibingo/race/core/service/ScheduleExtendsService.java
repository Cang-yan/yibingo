 ...
 */
@Service
public class ScheduleExtendsService {

    @Autowired
    ScheduleService scheduleService;

    public List<Schedule> getListByFilter(ScheduleFilterMapper filterMapper) {
        ...
        Page<Schedule> markPage = new Page<>(page, row);

        Page<Schedule> resultList = scheduleService.page(markPage, wrapper);

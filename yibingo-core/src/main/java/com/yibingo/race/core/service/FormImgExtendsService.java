 ...
 */
@Service
public class FormImgExtendsService {

    @Autowired
    FormImgService formImgService;

    public List<FormImg> getListByFilter(FormImgFilterMapper filterMapper) {

        QueryWrapper<FormImg> wrapper = new QueryWrapper<>();
        ...
        Page<FormImg> markPage = new Page<>(page, row);

        Page<FormImg> resultList = formImgService.page(markPage, wrapper);

 ...
 */
@Service
public class ImgLabelExtendsService {

    @Autowired
    private ImgLabelService imgLabelService;

    public List<ImgLabel> getListByFilter(ImgLabelFilterMapper filterMapper) {

        QueryWrapper<ImgLabel> wrapper = new QueryWrapper<>();
        ...
        Page<ImgLabel> markPage = new Page<>(page, row);

        Page<ImgLabel> resultList = imgLabelService.page(markPage, wrapper);

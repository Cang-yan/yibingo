 ...
 */
@Service
public class VipExtendsService {

    @Autowired
    VipService vipService;

    public List<Vip> getListByFilter(VipFilterMapper filterMapper) {
        ...
        Page<Vip> markPage = new Page<>(page, row);

        Page<Vip> resultList = vipService.page(markPage, wrapper);

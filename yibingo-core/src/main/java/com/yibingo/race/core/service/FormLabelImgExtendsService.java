 ...
 */
@Service
public class FormLabelImgExtendsService {

    @Autowired
    private FormLabelImgService formLabelImgService;

    public List<FormLabelImg> getListByFilter(FormLabelImgFilterMapper filterMapper) {

        QueryWrapper<FormLabelImg> wrapper = new QueryWrapper<>();
        ...
        Page<FormLabelImg> markPage = new Page<>(page, row);

        Page<FormLabelImg> resultList = formLabelImgService.page(markPage, wrapper);
